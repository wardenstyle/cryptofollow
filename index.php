...
<head>
    <meta charset="utf-8">
    <title>CryptoFollow Suivez vos crypto</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <a href="" class="nav-item nav-link">Connectez-vous</a>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <i class="fa fa-check bg-light text-primary btn-sm-square rounded-circle me-3 fw-bold"></i>
                            <span>Poser des indicateurs a une date fixée</span>
                        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex align-items-start">
                        <img class="img-fluid flex-shrink-0" src="img/coingecko1.png" alt="">
                        <div class="ps-4">
                            <h5 class="mb-3">Coingecko</h5>
                            <span>Restitution des données par l'API Coingecko</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-3">Un narratif d'actualité</h5>
                            <span>Un marché en pleine croissance</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-3">24/7 en ligne</h5>
                            <span>Site internet toujours en ligne</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl bg-light py-5 my-5">
        <div class="container py-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-6">1 Service, 3 étapes</h1>
                <p class="text-primary fs-5 mb-5">Consulter, indiquer, comparer</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white p-5">
                        ...
                        <a href="">Cliquez ici <i class="fa fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white p-5">
                        ...
                        <h5 class="mb-3">Poser un indicateur</h5>
                        <p>Les indicateurs qui vous permettrons de suivre l'évolution</p>
        ...
        <div class="container">
            ...
            <div class="owl-carousel roadmap-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="roadmap-item">
                    ...
                    <h5>Janvier 2025</h5>
                    <span>La valeur du BTC a augmenté 25%</span>
                </div>
                <div class="roadmap-item">
                    <div class="roadmap-point"><span></span></div>
                    <h5>Mars 2025</h5>
                    <span>La valeur du BTC a diminué de 10%</span>
                </div>
                <div class="roadmap-item">
                    <div class="roadmap-point"><span></span></div>
                    <h5>May 2025</h5>
                    <span>La valeur de ETH a augmenté de 25% </span>
                </div>
                <div class="roadmap-item">
                    <div class="roadmap-point"><span></span></div>
                    <h5>Juillet 2025</h5>
                    <span>La valeur de ETH a diminué de 10%</span>
    ...
    <div class="container-fluid bg-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-md-6">
                    <h1 class="text-primary mb-4"><img class="img-fluid me-2" src="img/icon-1.png" alt="" style="width: 45px;">CryptoFollow</h1>
                    <span>Site purement fictif réalisé dans le cadre d'un exercice.</span>
                </div>
